...
public class VideoService {
  ...
  @PostConstruct
  void initDatabase() {
    repository.save(new VideoEntity("alice", "Need HELP with your SPRING BOOT 4 App?",
      "SPRING BOOT 4 will only speed things up and make it super SIMPLE to serve templates and raw data."));
